...
/*     */ 
/*     */ public class EntityStarplatinum_punch
/*     */   extends Entity
...
/*     */   public EntityStarplatinum shootingStand;
...
/*     */   private double dz;
/*     */   
/*     */   public EntityStarplatinum_punch(World par1World) {
/*  56 */     super(par1World);
...
/*     */ 
/*     */   
/*     */   public EntityStarplatinum_punch(World par1World, double par2, double par4, double par6) {
/*  63 */     super(par1World);
...
/*     */ 
/*     */   
/*     */   public EntityStarplatinum_punch(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
/*  72 */     super(par1World);
/*  73 */     this.renderDistanceWeight = 10.0D;
/*  74 */     this.shootingEntity = par2EntityLivingBase;
/*  75 */     this.shootingStand = (EntityStarplatinum)par2EntityLivingBase;
/*     */     
...
/*     */ 
/*     */   
/*     */   public EntityStarplatinum_punch(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
/* 103 */     super(par1World);
/* 104 */     this.renderDistanceWeight = 10.0D;
/* 105 */     this.shootingEntity = par2EntityLivingBase;
/* 106 */     this.shootingStand = (EntityStarplatinum)par2EntityLivingBase;
/*     */     
...
/* 321 */               float p2 = 0.4F;
/*     */               
/* 323 */               if (movingobjectposition.entityHit instanceof src.jojobadv.Entities.EntityVampire) {
/*     */                 
/* 325 */                 movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.shootingStand.getMaster()), 10.0F);
/* 326 */                 movingobjectposition.entityHit.hurtResistantTime = 0;
/* 327 */                 movingobjectposition.entityHit.motionX = 0.0D;
/* 328 */                 if (movingobjectposition.entityHit.posY > this.shootingStand.posY + 3.0D) {
/*     */                   
/* 330 */                   movingobjectposition.entityHit.motionY -= p2;
/*     */                 }
/*     */                 else {
/*     */                   
/* 334 */                   movingobjectposition.entityHit.motionY -= p;
/*     */                 } 
/* 336 */                 movingobjectposition.entityHit.motionZ = 0.0D;
/* 337 */                 setDead();
/*     */               }
/* 339 */               else if (movingobjectposition.entityHit instanceof Entityhamonuser) {
/*     */                 
/* 341 */                 Entityhamonuser hamonuser = (Entityhamonuser)movingobjectposition.entityHit;
/* 342 */                 if (hamonuser.getOwner() == this.shootingStand.getMaster())
/*     */                 {
/* 344 */                   movingobjectposition = null;
/*     */                 }
/*     */                 else
/*     */                 {
/* 348 */                   movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.shootingStand.getMaster()), 3.0F);
/* 349 */                   movingobjectposition.entityHit.hurtResistantTime = 0;
/* 350 */                   movingobjectposition.entityHit.motionX = 0.0D;
/* 351 */                   if (movingobjectposition.entityHit.posY > this.shootingStand.posY + 3.0D) {
/*     */                     
/* 353 */                     movingobjectposition.entityHit.motionY -= p2;
/*     */                   }
/*     */                   else {
/*     */                     
/* 357 */                     movingobjectposition.entityHit.motionY -= p;
/*     */                   } 
/* 359 */                   movingobjectposition.entityHit.motionZ = 0.0D;
/* 360 */                   setDead();
/*     */                 }
/*     */               
/*     */               } else {
/*     */                 
/* 365 */                 movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.shootingStand.getMaster()), 3.0F);
/* 366 */                 movingobjectposition.entityHit.hurtResistantTime = 0;
/* 367 */                 movingobjectposition.entityHit.motionX = 0.0D;
/* 368 */                 if (movingobjectposition.entityHit.posY > this.shootingStand.posY + 3.0D) {
/*     */                   
/* 370 */                   movingobjectposition.entityHit.motionY -= p2;
/*     */                 }
/*     */                 else {
/*     */                   
/* 374 */                   movingobjectposition.entityHit.motionY -= p;
/*     */                 } 
/* 376 */                 movingobjectposition.entityHit.motionZ = 0.0D;
/* 377 */                 setDead();
/*     */               
/*     */               }
/*     */ 
...
/*     */         else {
/*     */           
/* 388 */           this.worldObj.spawnParticle("largeexplode", this.posX, this.posY, this.posZ, 1.0D, 0.0D, 0.0D);
/* 389 */           this.xTile = movingobjectposition.blockX;
/* 390 */           this.yTile = movingobjectposition.blockY;
/* 391 */           this.zTile = movingobjectposition.blockZ;
/* 392 */           this.inTile = Block.getIdFromBlock(this.worldObj.getBlock(this.xTile, this.yTile, this.zTile));
/* 393 */           this.inData = this.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile);
/* 394 */           this.motionX = (float)(movingobjectposition.hitVec.xCoord - this.posX);
/* 395 */           this.motionY = (float)(movingobjectposition.hitVec.yCoord - this.posY);
/* 396 */           this.motionZ = (float)(movingobjectposition.hitVec.zCoord - this.posZ);
/* 397 */           float f2 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
/* 398 */           this.posX -= this.motionX / f2 * 0.05000000074505806D;
/* 399 */           this.posY -= this.motionY / f2 * 0.05000000074505806D;
/* 400 */           this.posZ -= this.motionZ / f2 * 0.05000000074505806D;
/* 401 */           this.inGround = true;
/* 402 */           this.arrowShake = 7;
/* 403 */           setIsCritical(false);
/* 404 */           int p = 3;
/* 405 */           Block blockB = Block.getBlockById(this.inTile);
/*     */           
/* 407 */           float hardness = blockB.getBlockHardness(this.worldObj, this.xTile, this.yTile, this.zTile);
/* 408 */           if (hardness != -1.0F && hardness <= 5.0F) {
/*     */ 
/*     */ 
/*     */             
/* 412 */             if (!this.worldObj.isRemote)
/*     */             {
/* 414 */               //blockB.dropBlockAsItemWithChance(this.worldObj, this.xTile, this.yTile, this.zTile, this.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile), 1.0F, 0);
/* 415 */               //this.worldObj.setBlockToAir(this.xTile, this.yTile, this.zTile);
/* 416 */               setDead();
/*     */             }
/*     */           
/*     */           } else {
...
/*     */           } 
/*     */           
/* 424 */           if (this.inTile != 0)
/*     */           {
/* 426 */             Block.getBlockById(this.inTile).onEntityCollidedWithBlock(this.worldObj, this.xTile, this.yTile, this.zTile, this);
/*     */           }
/*     */         } 
/*     */       }
/*     */       
/* 431 */       if (getIsCritical())
/*     */       {
/* 433 */         for (l = 0; l < 4; l++)
/*     */         {
/* 435 */           this.worldObj.spawnParticle("crit", this.posX + this.motionX * l / 4.0D, this.posY + this.motionY * l / 4.0D, this.posZ + this.motionZ * l / 4.0D, -this.motionX, -this.motionY + 0.2D, -this.motionZ);
/*     */         }
/*     */       }
/*     */       
/* 439 */       this.posX += this.motionX;
/* 440 */       this.posY += this.motionY;
/* 441 */       this.posZ += this.motionZ;
/* 442 */       float f2 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
/* 443 */       this.rotationYaw = (float)(Math.atan2(this.motionX, this.motionZ) * 180.0D / Math.PI);
/*     */       
/* 445 */       for (this.rotationPitch = (float)(Math.atan2(this.motionY, f2) * 180.0D / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 450 */       while (this.rotationPitch - this.prevRotationPitch >= 180.0F)
/*     */       {
/* 452 */         this.prevRotationPitch += 360.0F;
/*     */       }
/*     */       
/* 455 */       while (this.rotationYaw - this.prevRotationYaw < -180.0F)
/*     */       {
/* 457 */         this.prevRotationYaw -= 360.0F;
/*     */       }
/*     */       
/* 460 */       while (this.rotationYaw - this.prevRotationYaw >= 180.0F)
/*     */       {
/* 462 */         this.prevRotationYaw += 360.0F;
/*     */       }
/*     */       
/* 465 */       this.rotationPitch = this.prevRotationPitch + (this.rotationPitch - this.prevRotationPitch) * 0.2F;
/* 466 */       this.rotationYaw = this.prevRotationYaw + (this.rotationYaw - this.prevRotationYaw) * 0.2F;
/* 467 */       float f4 = 0.99F;
/* 468 */       float f1 = 0.05F;
/*     */       
/* 470 */       if (isInWater()) {
/*     */         
/* 472 */         for (int j1 = 0; j1 < 4; j1++) {
/*     */           
/* 474 */           float f3 = 0.25F;
/* 475 */           this.worldObj.spawnParticle("bubble", this.posX - this.motionX * f3, this.posY - this.motionY * f3, this.posZ - this.motionZ * f3, this.motionX, this.motionY, this.motionZ);
/*     */         } 
/*     */         
/* 478 */         f4 = 0.8F;
/*     */       } 
...
/* 483 */       this.motionZ *= f4;
/* 484 */       this.motionY -= f1;
/* 485 */       setPosition(this.posX, this.posY, this.posZ);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 494 */     par1NBTTagCompound.setShort("xTile", (short)this.xTile);
/* 495 */     par1NBTTagCompound.setShort("yTile", (short)this.yTile);
/* 496 */     par1NBTTagCompound.setShort("zTile", (short)this.zTile);
/* 497 */     par1NBTTagCompound.setByte("inTile", (byte)this.inTile);
/* 498 */     par1NBTTagCompound.setByte("inData", (byte)this.inData);
/* 499 */     par1NBTTagCompound.setByte("shake", (byte)this.arrowShake);
/* 500 */     par1NBTTagCompound.setByte("inGround", (byte)(this.inGround ? 1 : 0));
/* 501 */     par1NBTTagCompound.setByte("pickup", (byte)this.canBePickedUp);
/* 502 */     par1NBTTagCompound.setDouble("damage", this.damage);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 510 */     this.xTile = par1NBTTagCompound.getShort("xTile");
/* 511 */     this.yTile = par1NBTTagCompound.getShort("yTile");
/* 512 */     this.zTile = par1NBTTagCompound.getShort("zTile");
/* 513 */     this.inTile = par1NBTTagCompound.getByte("inTile") & 0xFF;
/* 514 */     this.inData = par1NBTTagCompound.getByte("inData") & 0xFF;
/* 515 */     this.arrowShake = par1NBTTagCompound.getByte("shake") & 0xFF;
/* 516 */     this.inGround = (par1NBTTagCompound.getByte("inGround") == 1);
/*     */     
/* 518 */     if (par1NBTTagCompound.hasKey("damage"))
/*     */     {
/* 520 */       this.damage = par1NBTTagCompound.getDouble("damage");
/*     */     }
/*     */     
/* 523 */     if (par1NBTTagCompound.hasKey("pickup")) {
/*     */       
/* 525 */       this.canBePickedUp = par1NBTTagCompound.getByte("pickup");
/*     */     }
/* 527 */     else if (par1NBTTagCompound.hasKey("player")) {
/*     */       
/* 529 */       this.canBePickedUp = par1NBTTagCompound.getBoolean("player") ? 1 : 0;
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 539 */   protected boolean canTriggerWalking() { return false; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*     */   @SideOnly(Side.CLIENT)
/* 545 */   public float getShadowSize() { return 0.5F; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 550 */   public void setDamage(double par1) { this.damage = par1; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 555 */   public double getDamage() { return this.damage; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 563 */   public void setKnockbackStrength(int par1) { this.knockbackStrength = par1; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 571 */   public boolean canAttackWithItem() { return false; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 579 */     byte b0 = this.dataWatcher.getWatchableObjectByte(16);
/*     */     
/* 581 */     if (par1) {
/*     */       
/* 583 */       this.dataWatcher.updateObject(16, Byte.valueOf((byte)(b0 | 1)));
/*     */     }
/*     */     else {
/*     */       
/* 587 */       this.dataWatcher.updateObject(16, Byte.valueOf((byte)(b0 & 0xFFFFFFFE)));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 596 */     byte b0 = this.dataWatcher.getWatchableObjectByte(16);
/* 597 */     return ((b0 & 1) != 0);
/*     */   }
/*     */ }


/* Location:              /Volumes/NO NAME/JojoBAdv-0.2.4-1.7.10-deobf.jar!/src/jojobadv/Entities/Stands/EntityStarplatinum_punch.class
