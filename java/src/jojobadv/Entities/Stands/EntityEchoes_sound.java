...
/* 148 */     par3 /= f2;
/* 149 */     par5 /= f2;
/* 150 */     par1 += this.rand.nextGaussian() * (this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * par8;
/* 151 */     par3 += this.rand.nextGaussian() * (this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * par8;
/* 152 */     par5 += this.rand.nextGaussian() * (this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937D * par8;
/* 153 */     par1 *= par7;
/* 154 */     par3 *= par7;
/* 155 */     par5 *= par7;
...
/* 361 */                   ((EntityLivingBase)movingobjectposition.entityHit).addPotionEffect(new PotionEffect(Potion.weakness.getId(), 100, 1));
/* 362 */                   setDead();
/*     */                 }
/*     */               
/*     */               } 
...
/* 619 */     if (par1) {
/*     */       
/* 621 */       this.dataWatcher.updateObject(16, Byte.valueOf((byte)(b0 | 1)));
/*     */     }
/*     */     else {
/*     */       
