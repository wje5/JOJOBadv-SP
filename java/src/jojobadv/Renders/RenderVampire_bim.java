...
/*     */ import src.jojobadv.Entities.EntityVampire_bim;
/*     */ 
/*     */ 
/*     */ 
/*     */ @SideOnly(Side.CLIENT)
/*     */ public class RenderVampire_bim
/*     */   extends Render
/*     */ {
/*  19 */   private static final ResourceLocation Vampire_bimTextures = new ResourceLocation("jojobadv", "textures/vampire/laserT.png");
/*     */ 
/*     */   
/*     */   public void renderVampire_bim(EntityVampire_bim par1EntityVampire_bim, double par2, double par4, double par6, float par8, float par9) {
/*  23 */     bindEntityTexture(par1EntityVampire_bim);
/*  24 */     GL11.glPushMatrix();
/*  25 */     GL11.glTranslatef((float)par2, (float)par4, (float)par6);
/*  26 */     GL11.glRotatef(par1EntityVampire_bim.prevRotationYaw + (par1EntityVampire_bim.rotationYaw - par1EntityVampire_bim.prevRotationYaw) * par9 - 90.0F, 0.0F, 1.0F, 0.0F);
/*  27 */     GL11.glRotatef(par1EntityVampire_bim.prevRotationPitch + (par1EntityVampire_bim.rotationPitch - par1EntityVampire_bim.prevRotationPitch) * par9, 0.0F, 0.0F, 1.0F);
...
/*  40 */     float f11 = par1EntityVampire_bim.arrowShake - par9;
/*     */     
/*  42 */     if (f11 > 0.0F) {
/*     */       
/*  44 */       float f12 = -MathHelper.sin(f11 * 3.0F) * f11;
/*  45 */       GL11.glRotatef(f12, 0.0F, 1.0F, 0.0F);
/*     */     } 
/*     */     
...
/*     */ 
/*     */   
/*  84 */   protected ResourceLocation getVampire_bimTextures(EntityVampire_bim par1EntityVampire_bim) { return Vampire_bimTextures; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  92 */   protected ResourceLocation getEntityTexture(Entity par1Entity) { return getVampire_bimTextures((EntityVampire_bim)par1Entity); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 103 */   public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) { renderVampire_bim((EntityVampire_bim)par1Entity, par2, par4, par6, par8, par9); }
/*     */ }


/* Location:              /Volumes/NO NAME/JojoBAdv-0.2.4-1.7.10-deobf.jar!/src/jojobadv/Renders/RenderVampire_bim.class
